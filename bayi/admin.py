...
class UrunlerAdmin(admin.ModelAdmin):
    list_display = ('urun_ad','ebat','fiyat','status') # gösterilecek olan parametreler
    ...
    def status(self,request,queryset):
            ...
            self.message_user(request,f"{count} adet ürün eklendi")

    status.short_description ='İşaretlenen Ürünleri Ekle'
